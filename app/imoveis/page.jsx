...
const MAPA_VISIBILIDADE = {
  casa: [
    ...
    'cerca_eletrica',
    'churrasqueira',
    'churrasqueira_gourmet',
    'closet',
    'copa',
    'cozinha',
    'cozinha_americana',
    'cozinha_gourmet',
    'cozinha_independente',
    'decorado',
    'dep_empregados',
    'deposito',
    'despensa',
    ...
    'piscina_aquecida',
    'piscina_climatizada',
    'piscina_coberta_climatizada',
    'piscina_coberta_raia',
    'piscina_hidromassagem',
    'piscina_infantil',
    'piscina_raia',
    'piso_frio',
    'piso_laminado',
